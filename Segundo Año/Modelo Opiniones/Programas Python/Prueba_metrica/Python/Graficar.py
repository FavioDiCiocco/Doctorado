...
for carp in Carpetas:
    ...
    Estados = func.Identificacion_Estados(Dic_Total[6][0][1.5]["Entropia"],
                                          Dic_Total[6][0][1.5]["Sigmax"],
                                          Dic_Total[6][0][1.5]["Sigmay"],
                                          Dic_Total[6][0][1.5]["Covarianza"],
                                          Dic_Total[6][0][1.5]["Promedios"])
