...
Etapa = Path("Prueba_ventana") # Defino el nombre de la etapa del trabajo en la que estoy
...
for carp in Carpetas:
    ...
    # "Opiniones_N=$_kappa=$_beta=$_cosd=$_vent=$_Iter=$.file"
    # "Testigos_N=$_kappa=$_beta=$_cosd=$_vent=$_Iter=$.file"
    ...
    Df_archivos["ventana"] = Df_archivos["nombre"].apply(lambda x: int(x.split("_")[5].split("=")[1]))
