...
int main(int argc, char *argv[]){
	...
	// Creo mis punteros a structs y los malloqueo.
		...
		char s_archivo1[355];
		sprintf(s_archivo1,"../Programas Python/Transcritico/Norm_Maxima/Opiniones_alfa=%.3f_N=%d_Cosd=%.3f_mu=%.3f_Iter=%d.file"
		...
		char s_archivo2[355];
		sprintf(s_archivo2,"../Programas Python/Transcritico/Norm_Maxima/Testigos_alfa=%.3f_N=%d_Cosd=%.3f_mu=%.3f_Iter=%d.file"
			,ps_datos->f_alfa,ps_datos->i_N,ps_datos->f_Cosangulo,ps_datos->d_mu,i_iteracion);
