...
# Voy a intentar mezclar todas las combinaciones de estas preguntas, pero honestamente no sé cómo se escriben los nombres de los
# archivos de estas preguntas
Preguntas = ["201372","201386","201408","201411","201420","201426","202255","202328","202331","202341","202350"]
Lista_provisoria = ["V{}x_vs_V{}x.csv".format(num1,num2) for num1 in Preguntas for num2 in Preguntas]

Pruebas = [nombre in list(Df_dist_JS.index) for nombre in Lista_provisoria]

Lista_subconj = list(np.array(Lista_provisoria)[Pruebas])
...
# Reduzco dimensionalidad usando Multi-Dimensional Scaling
mds = MDS(n_components = 2, random_state = 42, dissimilarity = "precomputed", normalized_stress = "auto")
X_2d = mds.fit_transform(Subconj_JS.to_numpy())
...
plt.xlabel("Cant. Clusters")
plt.grid()
direccion_guardado = Path("../../../Imagenes/Barrido_final/Distr_encuestas/SilhouetteS_Kmeans_subconj.png")
plt.savefig(direccion_guardado ,bbox_inches = "tight")
plt.close()
...
plt.xlabel("Cant. Clusters")
plt.grid()
direccion_guardado = Path("../../../Imagenes/Barrido_final/Distr_encuestas/SSE_Kmeans_Subconj.png")
plt.savefig(direccion_guardado ,bbox_inches = "tight")
plt.close()
...
#     plt.plot(x, y, color='k', linestyle = "dashed", linewidth=tlinea, alpha = 0.4) # label=r'Mezcla: CR (40~80%) y PIa (10~45%)')
#     plt.text(0.3, 0.45, 'VII', fontsize=40, ha='center', va='center', color='k')
#     plt.scatter(X,Y, marker="o", c = kmeans_esp.labels_ , s = 900, cmap = colmap , alpha = 0.7)
#     plt.gca().xaxis.set_major_formatter(FuncFormatter(lambda val, pos: f'{val:.2f}'))
#     plt.xlabel(r"$cos(\delta)$")
#     plt.ylabel(r"$\beta$")
#     plt.xlim(-0.025,0.525)
...
#     direccion_guardado = Path("../../../Imagenes/Barrido_final/Distr_encuestas/Esp_parametros_Clust_JS_r{}.png".format(int(rank/10)))
#     plt.savefig(direccion_guardado ,bbox_inches = "tight")
#     plt.close()
...
plt.xlim(-0.025,0.525)
plt.ylim(0,1.55)
direccion_guardado = Path("../../../Imagenes/Barrido_final/Distr_encuestas/Esp_parametros_Clust_Subconj_k=3_JS.png")
plt.savefig(direccion_guardado ,bbox_inches = "tight")
plt.close()
