...
y = [0, 0, 2, 2]  # y-coordinates
ax.fill(x, y, color='tab:gray')  # 'alpha' adjusts transparency
ax.plot([], [], color='tab:gray', label='Consenso Neutral', linewidth=tlinea)
...
ax.plot([], [], color='tab:orange', label='Polarización Descorrelacionada', linewidth=tlinea)
...
ax.plot([], [], color='tab:green', label='Consenso Radicalizado', linewidth=tlinea)
...
ax.plot([], [], color='tab:blue', label=r'Mezcla: CR (40~80%) y P1Da (20~40%)', linewidth=tlinea)
...
ax.plot([], [], color='tab:purple', label=r'Mezcla: CR (60~80%), P1D (20~30%) y PDa (10%)', linewidth=tlinea)
...
# Región de Consenso Radicalizado
x = [0, 1, 1, 0.8, 0.6, 0.2, 0.1, 0]  # x-coordinates
y = [0, 0, 0.15, 0.2, 0.25, 0.3, 0.3, 0.2]  # y-coordinates
ax.fill(x, y, color='tab:green')  # 'alpha' adjusts transparency
x = [0.1, 0.2, 0.3, 1, 1, 0.1]  # x-coordinates
y = [0.3, 0.3, 0.6, 0.6, 1.1, 1.1]  # y-coordinates
ax.fill(x, y, color='tab:green')  # 'alpha' adjusts transparency
ax.plot([], [], color='tab:green', label='Consenso Radicalizado', linewidth=tlinea)

# Región de Polarización Descorrelacionada
x = [0, 0.1, 0.2, 0.2, 0]  # x-coordinates
y = [1.1, 1.1, 1.3, 2, 2]  # y-coordinates
ax.fill(x, y, color='tab:orange')  # 'alpha' adjusts transparency
ax.plot([], [], color='tab:orange', label='Polarización Descorrelacionada', linewidth=tlinea)

# Región de Transición
x = [0.1, 0.2, 0.3, 0.4, 0.4, 0.2, 0.2]  # x-coordinates
y = [1.1, 1.1, 1.3, 1.5, 2, 2, 1.3]  # y-coordinates
ax.fill(x, y, color='tab:olive')  # 'alpha' adjusts transparency
ax.plot([], [], color='tab:olive', label='Transición', linewidth=tlinea)
...
ax.plot([], [], color='tab:red', label='Polarización Ideológica', linewidth=tlinea)

# Región de Mezcla 1
x = [0.2, 0.6, 0.8, 1, 1, 0.3] # x-coordinates
y = [0.3, 0.25, 0.2, 0.15, 0.6, 0.6] # y-coordinates
ax.fill(x, y, color='tab:blue')  # 'alpha' adjusts transparency
ax.plot([], [], color='tab:blue', label=r'Mezcla: CR (40~80%) y PIa (10~45%)', linewidth=tlinea)

# Región de Mezcla 2
x = [0, 0.1, 0.1, 0] # x-coordinates
y = [0.2, 0.3, 0.7, 0.7] # y-coordinates
ax.fill(x, y, color='tab:purple')  # 'alpha' adjusts transparency
ax.plot([], [], color='tab:purple', label=r'Mezcla: CR (50~80%), P1Da (20~35%)', linewidth=tlinea)

# Región de Mezcla 3
x = [0, 0.1, 0.1, 0] # x-coordinates
y = [0.7, 0.7, 1.1, 1.1] # y-coordinates
ax.fill(x, y, color='tab:brown')  # 'alpha' adjusts transparency
ax.plot([], [], color='tab:brown', label=r'Mezcla: CR (30~40%), P1D (10~50%)', linewidth=tlinea)
