...
// TextMatriz es un string que define dónde se encuentra la matriz de Erdos-Renyi a utilizar. Modificar según dónde ubiquen la
// carpeta con redes de Erdos-Renyi de 10000 agentes.
...
// Estas son unas funciones que agregué para constuir la matriz de Superposición de tópicos, escribir vectores en los archivos
// de salida, contar la cantidad de agentes en cada región del espacio de opiniones y para calcular la norma en el espacio no ortogonal.
// No es necesario modificar nada de esto.
...
int main(int argc, char *argv[])
{
	...
	// IMPORTANTE
	// ESTO DEFINE DÓNDE SE GUARDA EL ARCHIVO DE SALIDA, MODIFICARLO PARA QUE APUNTE A UNA CARPETA EXISTENTE
